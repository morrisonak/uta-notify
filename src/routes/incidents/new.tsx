  ...
  return (
    <div className="p-6">
      <PageHeader
        ...
        description="Fill in the details below to create a new incident"
      />
              ...
              <div className="flex items-center justify-between mb-1">
                ...
                <div className="relative">
                  ...
                  {showTemplateDropdown && templates.length > 0 && (
                    <div className="absolute right-0 z-20 mt-1 w-72 max-h-64 overflow-y-auto rounded-xl border bg-background shadow-lg">
                      ...
                      {templates.map((template) => (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            {template.is_default === 1 && <Badge variant="default" className="text-[10px] px-1.5 py-0.5">Default</Badge>}
                          </div>
