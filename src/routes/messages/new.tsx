...
import { getIncidents, type Incident } from "../../server/incidents";
import {
...
function NewMessagePage() {
  ...
  // Load templates when incident is selected
  useEffect(() => {
    if (selectedIncident) {
            ...
            <div className="relative">
              ...
              {showTemplateDropdown && templates.length > 0 && (
                <>
                  ...
                  />
                  <div className="absolute z-20 mt-1 w-full max-h-64 overflow-y-auto rounded-lg border bg-background shadow-lg">
                    <button
                      type="button"
                      onClick={() => {
                        setSelectedTemplateId("");
